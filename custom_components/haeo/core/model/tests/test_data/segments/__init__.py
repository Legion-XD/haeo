...
from .tag_filter import SCENARIOS as TAG_FILTER_SCENARIOS
from .tag_pricing import SCENARIOS as TAG_PRICING_SCENARIOS
...
SEGMENT_SCENARIOS = [
    ...
    *TAG_PRICING_SCENARIOS,
    *TAG_FILTER_SCENARIOS,
]
