...
VALID_DATA = [
    {
        ...
        "config": {
            ...
            CONF_CALENDAR_ENTITY: "calendar.ev_trips",
            CONF_CONNECTED: "binary_sensor.ev_connected",
            CONF_ODOMETER: "sensor.ev_odometer",
            CONF_ODOMETER_AT_DISCONNECT: "sensor.ev_odometer_disconnect",
            SECTION_VEHICLE: {
    ...
    },
    {
        ...
        "config": {
            ...
            CONF_CONNECTION: as_connection_target("switchboard"),
            CONF_CALENDAR_ENTITY: "calendar.commute",
            CONF_CONNECTED: "binary_sensor.charger_connected",
            CONF_ODOMETER: "sensor.car_odometer",
            CONF_ODOMETER_AT_DISCONNECT: "sensor.car_odometer_disconnect",
            SECTION_VEHICLE: {
